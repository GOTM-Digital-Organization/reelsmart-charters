    ...
    <>
      ...
      <section className="py-20 bg-navy text-white">
        <div className="container">
          <div className="text-center mb-14">
            ...
            <p className="text-white/60 max-w-2xl mx-auto">All charters depart from Sarasota (1059 N Tamiami Trl) and cover the Venice area waters. 100% private — your group only.</p>
          </div>
      ...
      <section className="py-16 bg-off-white">
        <div className="container max-w-3xl text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link href="/contact" className="btn-gold px-6 py-3 rounded text-sm">
      ...
      <section className="py-16 bg-navy text-white text-center">
        <div className="container max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/contact" className="btn-gold px-10 py-4 rounded text-base">
              Book Now
            </Link>
